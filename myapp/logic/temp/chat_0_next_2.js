const dataSet = [
  ...
  function calculateProbability(number, pairFrequency) {
    if (!pairFrequency[number]) {
      return 0; // Number hasn't appeared with any of the pairs.
    }
  ...
  // Create an object to store the frequency of numbers that have appeared with the userPairs.
  const pairFrequency = {};
  
  // Iterate through the dataset and update the frequency of numbers that appeared with the pairs.
  ...
  // Find the numbers that have appeared most frequently with the userPairs.
  ...
  console.log("Numbers that appeared most frequently with the user-defined pairs are:", mostFrequentNumbers);
