...
// Function to select the next numbers in the line with the highest probabilities
function selectNextNumbers(dataSet, currentNumber, numToSelect) {
    const adjustedNextProbabilities = adjustNextNumberProbabilities(dataSet, currentNumber, numToSelect);
    return adjustedNextProbabilities.slice(0, numToSelect);
}
...
const selectedNumbers = selectNextNumbers(dataSet, numberToAnalyze, nextNumbersToSelect);
