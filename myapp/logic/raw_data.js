module.exports =  function getDataValues(arg){
    const dataSet = [
        ...
        [12,39,8,14,15,1,2,"October 18, 2023"],
        [26,11,36,46,19,6,4,"October 25, 2023"],
        
        [26,20,32,19,28,33,2,"November 2, 2023"],
        [46,14,20,8,40,6,4,"November 8, 2023"],
        [39,37,10,31,43,47,4,"November 15, 2023"],
        [11,35,23,33,25,47,2,"November 22, 2023"],
        [32,36,13,19,16,2,3,"November 29, 2023"],

        [12,17,48,43,15,9,4,"December 6, 2023"],
        [8,31,4,20,47,7,1,"December 13, 2023"],
        [25,45,29,1,43,48,2,"December 20, 2023"],
		[47,11,2,12,32,9,4,"December 27, 2023"],
        // 2024
        [32,17,40,45,22,47,1,"January 3, 2024"]
    ];
    ...
    switch(arg){
        case 1:
            return dataSet;
        case 2:
            return dataSetStript;
    };

    // console.log('dataSetStript: ', dataSetStript[0]);
}