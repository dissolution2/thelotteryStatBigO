const inFunc_setVikingLottoWinningRowToFreq = require('../logic/insert.js');

module.exports = function data_insert(){
...
console.log('we have inserted the data to the global varibales!!');
}